...
public class FoundryUtils
{
  ...
  static public void registerBasicMeltingRecipes(String partial_name,Fluid fluid)
  {
    if(FoundryAPI.recipes_melting != null)
    {
      ...
      FoundryAPI.recipes_melting.addRecipe(new OreMatcher("orePoor" + partial_name), new FluidStack(fluid, FoundryAPI.FLUID_AMOUNT_NUGGET * 3));
      ...
      FoundryAPI.recipes_melting.addRecipe(new OreMatcher("dustTiny" + partial_name), new FluidStack(fluid, FoundryAPI.FLUID_AMOUNT_NUGGET));
    }
  }
